...
setup_wallpaper() {
  ...
  if confirm "Do you want to setup a default wl wallpaper 103.jpeg? " 1; then
    echo "==> /usr/local/bin/wl set 103.jpeg"
    prevented_process /usr/local/bin/wl set 103.jpeg
  fi
