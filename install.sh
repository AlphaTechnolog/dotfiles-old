...
setup_wallpaper() {
  ...
  if confirm "Do you want to setup a default wl wallpaper 15.jpeg? " 1; then
    echo "==> $HOME/.local/bin/wl set 15.jpeg"
    prevented_process $HOME/.local/bin/wl set 15.jpeg
  fi
