...
setup_wallpaper() {
  ...
  if confirm "Do you want to setup a default wl wallpaper 41.jpeg? " 1; then
    echo "==> $HOME/.local/bin/wl set 41.jpeg"
    prevented_process $HOME/.local/bin/wl set 41.jpeg
  fi
