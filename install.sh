...
setup_wallpaper() {
  ...
  if confirm "Do you want to setup a default wl wallpaper 44.jpeg? " 1; then
    echo "==> $HOME/.local/bin/wl set 44.jpeg"
    prevented_process $HOME/.local/bin/wl set 44.jpeg
  fi
